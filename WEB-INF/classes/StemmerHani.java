...
/**
  * StemmerHani, implementing the Porter Stemming Algorithm

 The StemmerHani class transforms a word into its root form.  The input
...
{  static private char[] b;
   ...
   */
   ...
   /** Stem the word placed into the StemmerHani buffer through calls to add().
   ...
   /** Test program for demonstrating the StemmerHani.  It reads text from a
 a list of files, stems each word, and writes the result to standard
 output. Note that the word stemmed is expected to be in lower case:
 forcing lower case must be done outside the StemmerHani class.
 Usage: StemmerHani file-name file-name ...
    */
   public static void main(String[] args)
   {
   
    System.out.println(StemmerHani.stem("parties"));
    System.out.println(StemmerHani.stem("hello"));
    System.out.println(StemmerHani.stem("running"));
   }
}